...
### Store
Store и Reducers находятся в **/app/store/**.
- **UserSlice**. Здесь находятся основные состояния пользователя, такие как 
    - isAuth
    - email
    - token
    - id
...
Происходит отслуживание состояния isAuth из **store**. При авторизованном пользователе идет переадресация на страницу */tasks*, а при не авторизованном - */auth/login*
